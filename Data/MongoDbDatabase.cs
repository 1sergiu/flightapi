...
namespace FlightPlanApi.Data
{
    public class MongoDbDatabase : IDatabaseAdapter
    {
        ...
        public Task<bool> DeleteFlightPlan(string flightPlanId)
        {
            throw new NotImplementedException();
        }

        Task<TransactionResult> IDatabaseAdapter.FileFlightPlan(FlightPlan flightPlan)
        {
            throw new NotImplementedException();
        }

        Task<TransactionResult> IDatabaseAdapter.UpdateFlightPlan(string flightPlanId, FlightPlan flightPlan)
        {
            throw new NotImplementedException();
        }
    }
